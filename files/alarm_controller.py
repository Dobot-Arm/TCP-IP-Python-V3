alarm_controller_list = [
 ...
 },
 {
    ...
    "level": 5,
    "en": {
      "description": "Pause error reporting during track reproduction",
      "cause": "",
      "solution": "Pause function is not supported during track reproduction"
    },
    "zh_CN": {
      "description": "轨迹复现过程中暂停报错",
      "cause": "",
      "solution": "轨迹复现过程中不支持暂停功能"
    }
 },
  {
    "id": 161,
  ...
  },
 {
  ...
  },
  {
    ...
    "level": 0,
    "en": {
      "description": "Before power supply, the voltage is higher than 51V",
      "cause": "",
      "solution": "The voltage is too high，please contact technical support engineer"
    },
    "zh_CN": {
      "description": "供电前，电压高于51V",
      "cause": "",
  ...
  },
  {
    ...
    "level": 0,
    "en": {
      "description": "Before power supply, the voltage is lower than 45V",
      "cause": "",
      "solution": "The voltage is too low，please contact technical support engineer"
    },
    "zh_CN": {
      "description": "供电前，电压低于24V",
      "cause": "",
  ...
  },
 {
    ...
    "level": 0,
    "en": {
      "description": "After power supply, the voltage is higher than 55V",
      "cause": "",
      "solution": "The voltage is too high，please contact technical support engineer"
    },
    "zh_CN": {
      "description": "供电后，电压高于55V",
      "cause": "",
      "solution": "本体供电电压过高,请联系技术支持工程师"
    }
  },
 {
    ...
    "level": 0,
    "en": {
      "description": "After power supply, the voltage is lower than 41.4V",
      "cause": "",
      "solution": "The voltage is too low，please contact technical support engineer"
    },
    "zh_CN": {
      "description": "供电后，电压低于41.4V",
      "cause": "",
      "solution": "本体供电电压过低,请联系技术支持工程师"
    }
  },
  ...
  },
{
    ...
    "level": 5,
    "en": {
      "description": "The fan circuit of the feedback board is broken",
      "cause": "",
      "solution": "Check whether the hardware is working properly, and restart the controller， or contact technical support engineer"
    },
    "zh_CN": {
      "description": "馈能板电扇电流断路",
      "cause": "",
      "solution": "检查硬件是否正常并重新启动，或联系技术支持工程师"
    }
  },
  ...
  },
{
  ...
  },
  {
    ...
    "level": 5,
    "en": {
      "description": "Input params is error.",
      "cause": "",
      "solution": "Enter the correct parameters"
    },
    "zh_CN": {
  ...
  },
  {
    ...
    "zh_CN": {
      "description": "通用IO掉线，请确认安全IO板与通用IO板之间的EtherCAT链路",
      "cause": "",
      "solution": "检查硬件是否正常并重新启动，或联系技术支持工程师"
    }
  },
